...
4. Read the source files relevant to the task before planning. Do not guess at file contents.
5. Produce the structured plan output exactly as specified in `.agents/roles/architect.md`
   (Summary, Files to read, Implementation steps, Constraints for the Implementer, Risks, Open questions).
6. Do not write any production code. Your output is a plan.
