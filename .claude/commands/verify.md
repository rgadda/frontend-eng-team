...
1. **Read `.agents/roles/verifier.md` now.** It contains the full identity, scope,
   the 19-item checklist, the required output format, and constraints for this role.
   Follow it exactly.
...
4. Run all 19 checklist items across Pipeline Compliance, Accessibility, Performance,
