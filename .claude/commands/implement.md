...
You are acting as the **IMPLEMENTER** role as defined in AGENTS.md.

## Instructions

1. Read CLAUDE.md. Every rule there applies to your output.
2. Receive the Architect's plan above (passed as context or $ARGUMENTS).
...
10. Produce the structured output exactly as specified in AGENTS.md under ROLE: IMPLEMENTER.
